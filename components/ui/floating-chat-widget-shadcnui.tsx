      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className="w-[380px] overflow-hidden rounded-2xl border border-[var(--color-border)]/40 bg-[var(--color-bg)]/60 shadow-2xl backdrop-blur-xl ring-1 ring-white/10"
          >
            {/* Header */}
            ...
            {/* Chat Area */}
            <div className="flex h-[320px] flex-col gap-4 overflow-y-auto p-4 bg-gradient-to-b from-[var(--color-bg)]/20 to-[var(--color-bg)]/40">
              <motion.div variants={messageVariants} className="flex gap-3">
                <Avatar className="h-8 w-8 border border-[var(--color-border)]/40 shadow-sm">
                ...
                <div className="flex max-w-[85%] flex-col gap-1">
                  ...
                  <div className="rounded-2xl rounded-tl-none bg-[var(--color-bg-inset)] px-4 py-2.5 text-sm shadow-sm backdrop-blur-sm border border-[var(--color-border)]/20">
                    <p>
              ...
              >
                ...
                <div className="flex max-w-[85%] flex-col items-end gap-1">
                  <div className="rounded-2xl rounded-tr-none bg-[var(--color-accent)] px-4 py-2.5 text-sm text-white shadow-md">
              ...
              >
                ...
                <div className="flex flex-col gap-1">
                  <div className="rounded-2xl rounded-tl-none bg-[var(--color-bg-inset)] px-4 py-3 shadow-sm backdrop-blur-sm border border-[var(--color-border)]/20 w-16 flex items-center justify-center gap-1">
                    <span className="h-1.5 w-1.5 rounded-full bg-[var(--color-fg)]/40 animate-bounce [animation-delay:-0.3s]" />
                    <span className="h-1.5 w-1.5 rounded-full bg-[var(--color-fg)]/40 animate-bounce [animation-delay:-0.15s]" />
                    <span className="h-1.5 w-1.5 rounded-full bg-[var(--color-fg)]/40 animate-bounce" />
                  </div>
                </div>
              </motion.div>
            </div>
      ...
      <motion.button
        ...
        className={cn(
          ...
          isOpen
            ...
            : 'bg-[var(--color-accent)] text-white hover:shadow-[var(--color-accent-glow)]',
        )}
      >
